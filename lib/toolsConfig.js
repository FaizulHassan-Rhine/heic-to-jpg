...
export const MAIN_CATEGORIES = [
  ...
  },
  {
    ...
    paths: ["/doc-to-pdf", "/pdf-to-doc", "/scanner", "/merge-pdf", "/compress-pdf", "/pdf-unlock-protect", "/split-pdf"],
    items: [
...
export const OTHER_TOOLS_SECTIONS = [
  ...
  {
    title: "Utilities",
    paths: ["/qr-barcode", "/url-shortener", "/file-to-zip", "/calculators"],
    items: [
  ...
  {
    title: "Maps & Location",
    paths: ["/distance-calculator", "/radius-map", "/coordinates-finder", "/address-to-latlong", "/embed-map-generator"],
    items: [
