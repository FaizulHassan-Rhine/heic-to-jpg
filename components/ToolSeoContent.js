...
export default function ToolSeoContent({ content, showBreadcrumbs = true }) {
  ...
  return (
    <section className="border-t bg-muted/40" aria-label="Tool information">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4 not-prose">
            About {content.h1}
          </h2>
          ...
          {content.useCases?.length > 0 && (
            <>
              <h3 className="text-xl font-semibold text-foreground mt-10 mb-4">When to Use This Tool</h3>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-10 mb-4">Tips for Best Results</h3>
          <p className="text-muted-foreground dark:text-muted-foreground leading-relaxed mb-4">
          ...
          <p className="text-muted-foreground dark:text-muted-foreground leading-relaxed mb-8">
            ...
            tools linked below. Processing is private and on-the-fly — results are not saved to our servers.
          </p>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-10 mb-4">How to Use</h3>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-10 mb-4">Supported Formats</h3>
          <p className="text-muted-foreground dark:text-muted-foreground">{content.supportedFormats}</p>

          <h3 className="text-xl font-semibold text-foreground mt-10 mb-4">Privacy &amp; Security</h3>
          <p className="text-muted-foreground dark:text-muted-foreground">{content.privacySecurity}</p>

          {content.useCases?.length > 0 && (
            <>
              <h3 className="text-xl font-semibold text-foreground mt-10 mb-4">Common Use Cases</h3>
          ...
          {content.relatedTools?.length > 0 && (
            <>
              <h3 className="text-xl font-semibold text-foreground mt-10 mb-4">Related Tools</h3>
          ...
          {content.faqs?.length > 0 && (
            <>
              <h3 className="text-xl font-semibold text-foreground mt-10 mb-4">Frequently Asked Questions</h3>
