  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="relative border-b bg-gradient-to-br from-[#0F2854] via-[#1C4D8D] to-[#0F2854] text-white overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(189,232,245,0.2),_transparent_55%)]" />
        <div className="mx-auto w-full max-w-6xl px-4 py-12 md:py-14 relative">
          <Breadcrumbs items={breadcrumbs} variant="light" className="mb-6" />
          <div className="flex flex-wrap items-center gap-3 mb-5">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 border border-white/20 px-3 py-1 text-xs font-semibold text-[#BDE8F5]">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-tight mb-5 text-white">
            {post.title}
          </h1>
          <p className="text-lg text-white/80 leading-relaxed mb-6 max-w-3xl">{post.description}</p>
      ...
      <main className="flex-1">
        <div className="mx-auto w-full max-w-6xl px-4 py-10 md:py-14">
          ...
          <article className="lg:col-span-8">
            <Card className="border-border shadow-sm">
              <CardContent className="pt-8 pb-8 md:pt-10 md:pb-10 px-6 md:px-10">
                <ProseContent>{renderBlogMarkdown(post.content)}</ProseContent>
              </CardContent>
            </Card>

            <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-8 border-t border-border">
              <Link
                href="/blog"
          ...
          <aside className="lg:col-span-4 space-y-6">
            ...
            <Card className="border-border shadow-sm">
              <CardContent className="pt-6 pb-6">
                <h2 className="font-semibold text-foreground mb-4">More guides</h2>
            ...
            <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-transparent shadow-sm">
              <CardContent className="pt-6 pb-6">
                <h2 className="font-semibold text-foreground mb-2">Popular tools</h2>
                <ul className="space-y-2 text-sm">
                  ...
                  <li><Link href="/sample-files" className="text-primary hover:underline">Sample Files</Link></li>
                </ul>
              </CardContent>
            </Card>
          </aside>
